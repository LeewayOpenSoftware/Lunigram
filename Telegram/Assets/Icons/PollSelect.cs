...
#if LINUX
        // u004 / new PORTING.md §6 entry: Uno.UI's Microsoft.UI.Xaml.Controls.IAnimatedVisualSource
        // is NOT the real WinUI interface (TryCreateAnimatedVisual alone) -- it merges in the
        // interactive-player surface WinUI keeps on IDynamicAnimatedVisualSource (Update/Load/
        // Unload/Play/Stop/Pause/Resume/SetProgress/Measure). Measured reflecting Uno.UI.dll:
        // Microsoft.UI.Xaml.Controls.IAnimatedVisualSource has all 10 members, IAnimatedVisualSource2
        // adds Markers + SetColorProperty on top. This LottieGen output (auto-generated, only
        // TryCreateAnimatedVisual is hand-verified against Windows) is never assigned to an
        // AnimatedVisualPlayer.Source here -- it's consumed directly via TryCreateAnimatedVisual
        // (PollOptionContent.xaml.cs) -- so the player-lifecycle members are unreachable no-ops.
        void Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.Update(Microsoft.UI.Xaml.Controls.AnimatedVisualPlayer player) { }
        void Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.Load() { }
        void Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.Unload() { }
        void Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.Play(double fromProgress, double toProgress, bool looped) { }
        void Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.Stop() { }
        void Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.Pause() { }
        void Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.Resume() { }
        void Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.SetProgress(double progress) { }
        Windows.Foundation.Size Microsoft.UI.Xaml.Controls.IAnimatedVisualSource.Measure(Windows.Foundation.Size availableSize) => availableSize;
#endif
    }
}
