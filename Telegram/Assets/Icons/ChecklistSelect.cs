...
#if LINUX
        // u004 / new PORTING.md §6 entry: see PollSelect.cs for the measured detail -- Uno.UI's
        // Microsoft.UI.Xaml.Controls.IAnimatedVisualSource merges in the interactive-player
        // surface WinUI keeps separate (IDynamicAnimatedVisualSource). Unreachable here: this
        // LottieGen output is only ever consumed via TryCreateAnimatedVisual (PollOptionContent
        // and ChecklistTaskContent), never assigned to an AnimatedVisualPlayer.Source.
