...
#if LINUX
        public string DeviceModel => LinuxSystemInfo.DeviceModel;

        public string SystemVersion => LinuxSystemInfo.SystemVersion;

        public string SystemVersion2 => LinuxSystemInfo.KernelVersion;

        public string ApplicationVersion => LinuxSystemInfo.ApplicationVersion;

        public string ApplicationVersion2 => LinuxSystemInfo.ApplicationVersion2;

        public string SystemLanguageCode => LinuxSystemInfo.SystemLanguageCode;
#else
