...
namespace Telegram.Services
{
    ...
    public partial class NightModeService
    {
        ...
        {
#if LINUX
            // On this head the notification is also how the xdg-desktop-portal answer arrives, and
            // it may invalidate the theme the session was seeded with. See
            // AppearanceSettings.InvalidateDesktopColorScheme.
            if (AppSettings.Appearance.InvalidateDesktopColorScheme())
            {
                Update(false);
                return;
            }
