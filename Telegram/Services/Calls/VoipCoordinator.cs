...
// u-group-call-ui-port Phase 1: VideoChatAliasesPopup/RecordVideoChatPopup/ScheduleVideoChatPopup/
// VideoChatStreamsPopup are now wired into Telegram.Linux.csproj, so this using is unconditional.
...
namespace Telegram.Services
{
    public partial class VoipCoordinator
    {
        ...
        #region Group
        // u-group-call-ui-port Phase 1: un-stubbed. The #if LINUX stub (Logger.Info +
        // VoipGroupCallUnavailableLinux popup) that lived here until Phase 0 is gone now that
        // VoipGroupCall/GroupCallWindow/LiveStreamWindow are wired into Telegram.Linux.csproj.
        ...
        // u-group-call-ui-port Phase 1: un-stubbed (was #if LINUX / true-returning stubs).
