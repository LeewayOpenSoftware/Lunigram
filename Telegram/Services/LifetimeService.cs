...
namespace Telegram.Services
{
    ...
    public partial class LifetimeService : ILifetimeService
    {
        ...
        {
#if LINUX
            // The constructor is generated from Session.Registrations Globals, which on Linux
            // leave out IShortcutsService.
            var session = new SessionImpl(this, _locale, _passcode, _proxy, _downloads, id, active);
#else
