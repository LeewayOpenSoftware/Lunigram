...
// The list lives in LocalDatabase (winsqlite3) and the system proxy comes from WinHTTP; the
// Linux implementation in Telegram.Linux/Platform/ProxyService.cs keeps the interface above.
#if !LINUX
