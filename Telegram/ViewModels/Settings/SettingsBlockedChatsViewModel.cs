...
namespace Telegram.ViewModels.Settings
{
    public partial class SettingsBlockedChatsViewModel : ViewModelBase, IIncrementalCollectionOwner
    {
        ...
        // CC-2: ChooseChatsPopup.PickChatAsync is CC-1's ported popup used through its simple
        // Pick* surface (Task<Chat> via PickAsync -> ShowQueuedAsync), not the
        // ChooseChatsConfiguration/SendExecute dispatch -- so it does not depend on any of the 6
        // configs CC-1 left guarded. Same body on both platforms now.
