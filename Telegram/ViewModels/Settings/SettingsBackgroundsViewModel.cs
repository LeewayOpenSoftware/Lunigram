...
namespace Telegram.ViewModels.Settings
{
    public partial class SettingsBackgroundsViewModel : ViewModelBase, IHandle
    {
...
#else
        // COLLAPSED with its button (see SettingsBackgroundsPage.xaml.cs). The reason is written in
        // full at BackgroundViewModel.GetBackgroundAsync: the file picker is FALTA 1.5's open
        // unknown and the upload path needs the attach parcel's media-generation stack.
        // ChangeToLocalAsync is kept below because BackgroundsPopup (outside this parcel) calls it;
        // it is simply never reached from here.
        public void ChangeToLocal()
        {
        }
#endif
        ...
        // CC-2: CC-1 ported ChooseChatsPopup; sharing a background uses
