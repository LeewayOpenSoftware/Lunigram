...
namespace Telegram.ViewModels.Settings
{
    public partial class SettingsProxyViewModel : ViewModelBase, IHandle
    {
        ...
        {
#if !LINUX
            // Windows-only UWP network loopback restriction: BridgeApplicationContext is the
            // AppService/FullTrustProcessLauncher bridge to Telegram.Stub, not in the Linux
            // subset (same reason Passkeys stays out, u-020). No sandboxed loopback on Linux, so
            // nothing to exempt.
        ...
        // CC-2: CC-1 ported ChooseChatsPopup; sharing a proxy link uses
        // ChooseChatsConfigurationPostLink, one of the 13 configs CC-1 kept live.
    ...
    public partial class ProxyViewModel : BindableBase
    {
        ...
        // internal under #if LINUX: Uno's BindableTypeProviders generator can't qualify a
        // td_api.tl-generated type on a public property (typeof(global::Proxy), CS0400 -
        // PORTING.md 6, same fix as u004's PollOption/ChecklistTask). The generator only walks
        // public properties, and every consumer is same-assembly.
#if LINUX
        internal
#else
        public
#endif
            Proxy Proxy => _proxy.Proxy;
