...
namespace Telegram.ViewModels.Settings
{
    public partial class SettingsThemesViewModel : ViewModelBase
    {
        ...
        // CC-2: CC-1 ported ChooseChatsPopup; sharing a .attheme file uses
        // ChooseChatsConfigurationPostMessage, one of the 13 configs CC-1 kept live.
        ...
        public async void EditTheme(ThemeCustomInfo theme)
        {
            ...
            if (XamlRoot.TryGetContent(out RootWindow root))
            {
