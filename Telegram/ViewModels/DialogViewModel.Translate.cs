...
namespace Telegram.ViewModels
{
    public partial class DialogViewModel
    {
        ...
        {
            // Was #if !LINUX in its entirety. Un-fenced in u-013 because the flyout that reaches
            // it is now drawn (ChatTranslateBar's menu) and a dead entry there is exactly what
            // this project does not ship -- and because TranslateToPopup entered the subset in
            // u-005, so there is nothing left to fence off.
