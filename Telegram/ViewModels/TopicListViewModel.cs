...
#if LINUX
            // SupergroupTopicPopup (icon picker over the emoji drawer) is out of the Phase 1
            // subset; the menu entry that leads here is only offered when the user can create
            // topics, so it just does nothing for now.
            _ = chat;
#else
