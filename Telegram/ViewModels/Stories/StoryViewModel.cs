...
namespace Telegram.ViewModels.Stories
{
    public partial class StoryViewModel : BindableBase
    {
        ...
        //
        // Services/Calls/VoipGroupCall.cs is not in the Linux subset (only its base,
        // VoipCallBase.cs, is), and the only reader of this property is
        // Controls/Stories/StoryLiveInteractionBar.xaml.cs, which is not in it either: live
        // stories are a corner of the viewer, not of the strip.
