...
#if LINUX
                // Uno swallows exceptions thrown while building the page into NavigationFailed;
                // without a handler the frame simply stays empty.
                frame.NavigationFailed += (s, e) => Logger.Error($"{e.SourcePageType}: {e.Exception}");
#endif
