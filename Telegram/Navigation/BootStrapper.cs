...
#if LINUX
// Uno's Microsoft.UI.Xaml.LaunchActivatedEventArgs only carries Arguments; the UWP one it wraps
// has Kind, PreviousExecutionState and PrelaunchActivated, which is what the pipeline reads.
