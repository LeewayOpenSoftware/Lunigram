...
#if !LINUX
        // Windows.Data.Json is one of the namespaces Uno does not implement (PORTING.md 6); the
        // only caller is the HLS player, which is out of the subset with the rest of the video path.
