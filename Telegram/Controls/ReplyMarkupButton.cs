...
namespace Telegram.Controls
{
    public partial class ReplyMarkupButton : GlyphButton
    {
        ...
        // PORTING.md §6: a public property typed as a td_api.tl-generated class trips Uno's
        // BindableTypeProviders generator (CS0400), same fix as u-004/u-031/u-045 - demoted under
        // #if LINUX, the type itself is unaffected since ReplyMarkupPanel (the only reader) is in
        // the same assembly.
#if LINUX
        internal KeyboardButton Button { get; }
#else
    ...
    public partial class ReplyMarkupButtonAutomationPeer : ButtonAutomationPeer
    {
        ...
        {
            return Automation.GetNameCore(_owner.ContentRoot() ?? _owner) ?? base.GetNameCore();
        }
    }
}
