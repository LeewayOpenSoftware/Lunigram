...
namespace Telegram.Controls
{
    ...
    public partial class FileButton : GlyphHyperlinkButton
    {
        ...
        private void SetDownloadGlyphImpl(bool animate)
        {
...
#if LINUX
            arrowPath.SetPath(GetArrowShape()); // Path is typed on Uno's CompositionPath, see Telegram.Linux/Graphics/CompositionPath.cs
#else
            ...
            ScalarKeyFrameAnimation CreateTrimEnd()
            {
            ...
            leftLine.StartAnimation("TrimEnd", CreateTrimEnd());
            rightLine.StartAnimation("TrimEnd", CreateTrimEnd());
