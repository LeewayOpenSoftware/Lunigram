...
namespace Telegram.Controls.Chats
{
    public sealed partial class ChatJoinRequestsHeader : HyperlinkButton
    {
        ...
        public ChatJoinRequestsHeader()
        {
            ...
            // Subscribed here rather than from the markup: see the comment on RecentUsers in the
            // .xaml. Same on both platforms.
            RecentUsers.RecentUserHeadChanged += RecentUsers_RecentUserHeadChanged;
