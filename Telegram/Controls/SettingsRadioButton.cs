...
namespace Telegram.Controls
{
    public partial class SettingsRadioButton : FauxRadioButton
    {
        ...
        {
#if LINUX
            // Its <Style TargetType="controls:SettingsRadioButton"> in
            // Themes/RadioButton_themeresources.xaml is win:-only, so this type has no default
            // style here and the control would get no template at all.
            DefaultStyleKey = typeof(Microsoft.UI.Xaml.Controls.RadioButton);
#else
