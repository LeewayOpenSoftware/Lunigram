...
namespace Telegram.Controls
{
    ...
    public partial class EmojiSearchBox : Control
    {
        ...
        private void ShowHidePlaceholder(bool show)
        {
            ...
            {
                var animation = visual1.Compositor.CreateScalarKeyFrameAnimation();
            ...
            visual1.StartAnimation("Opacity", CreateOpacity());
            visual2.StartAnimation("Opacity", CreateOpacity());
        }
