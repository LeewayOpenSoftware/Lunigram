...
namespace Telegram.Controls.Gifts
{
    public sealed partial class GiftAttributeGauge : UserControl
    {
        ...
        private void InitializeProbability(float probability)
        {
            ...
            backgroundShape.StrokeStartCap = Microsoft.UI.Composition.CompositionStrokeCap.Round;
            backgroundShape.StrokeEndCap = Microsoft.UI.Composition.CompositionStrokeCap.Round;
            ...
            foregroundShape.StrokeStartCap = Microsoft.UI.Composition.CompositionStrokeCap.Round;
            foregroundShape.StrokeEndCap = Microsoft.UI.Composition.CompositionStrokeCap.Round;
