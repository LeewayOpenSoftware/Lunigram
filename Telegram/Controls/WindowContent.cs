...
namespace Telegram.Controls
{
    ...
    public partial class WindowContent : UserControlEx, IPopupHost
    {
        ...
        // Qualified: Microsoft.UI.Xaml also has a WindowActivatedEventArgs and both namespaces
        // are imported here. This handler hangs off WindowContext.Activated, which upstream 12.10
        // retyped to its own wrapper - the one that carries IsActive.
        private void OnWindowActivatedCore(object sender, Navigation.WindowActivatedEventArgs args)
        {
