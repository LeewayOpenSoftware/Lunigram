...
namespace Telegram.Controls.Cells
{
    public sealed partial class ForumTopicCell : ControlEx, IForumTopicDelegate
    {
        ...
        public void ShowPreview(Point? position)
        {
            ...
            _ = viewModel.NavigatedToAsync(new ChatMessageTopic(chat.Id, new MessageTopicForum(_topic.Info.ForumTopicId)), Microsoft.UI.Xaml.Navigation.NavigationMode.New, new Telegram.Navigation.Services.NavigationState());
