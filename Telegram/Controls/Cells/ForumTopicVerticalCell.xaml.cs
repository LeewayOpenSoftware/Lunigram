...
namespace Telegram.Controls.Cells
{
    public sealed partial class ForumTopicVerticalCell : ControlEx, IForumTopicDelegate, IDirectMessagesTopicDelegate
    {
        ...
        public void ShowPreview(Point? position)
        {
            ...
            if (_forumTopic != null)
            {
                _ = viewModel.NavigatedToAsync(new ChatMessageTopic(chat.Id, new MessageTopicForum(_forumTopic.Info.ForumTopicId)), Microsoft.UI.Xaml.Navigation.NavigationMode.New, new Telegram.Navigation.Services.NavigationState());
            }
            else if (_directMessagesChatTopic != null)
            {
                _ = viewModel.NavigatedToAsync(new ChatMessageTopic(chat.Id, new MessageTopicDirectMessages(_directMessagesChatTopic.Id)), Microsoft.UI.Xaml.Navigation.NavigationMode.New, new Telegram.Navigation.Services.NavigationState());
            }
