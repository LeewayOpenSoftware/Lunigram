...
namespace Telegram.Controls.Messages.Content
{
    ...
    public sealed partial class VoiceNoteContent : ControlEx, IContentWithFile
    {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (Recognize != null)
            {
                AutomationProperties.SetName(Recognize, Strings.AccActionOpenTranscription);
            }
...
#if LINUX
            // Telegram.Assets.Icons is LottieGen over Win2D; on Linux Dots is one of the inert
            // sources of Telegram.Linux/Xaml/IconStubs.cs and answers null, so the three animated
            // dots of a transcription in progress are simply absent. Without this the null would
            // be dereferenced one line below.
            if (_previous == null)
            {
