...
namespace Telegram.Controls.Messages.Service
{
    ...
    public sealed partial class MessagePhotoContent : MessageService
    {
        ...
        // CERRADO 2026-08-27 (PARIDAD M11). Este cuerpo estaba duplicado: la rama Linux
        // mandaba la mencion de historia a ExecuteServiceMessage -- que en esta cabeza es uno de
        // los metodos de cuerpo vacio de DialogViewModel.Linux.cs -- asi que pulsar «X publico una
        // historia» no hacia absolutamente nada, con los anillos dibujados encima de la foto
        // anunciando que habia algo que abrir. Ya no hay motivo para la copia: StoriesWindow existe
        // en esta cabeza (Telegram.Linux/Stories/StoriesWindow.cs, mismo namespace, mismo nombre y
        // la misma firma de Update), y ActiveStoriesViewModel / StoryListViewModel entran por el
        // csproj. El unico cuerpo es el de upstream.
