...
#if LINUX
        // u-groupcall-compile-clean: the queue's TryEnqueue takes
        // Microsoft.UI.Dispatching.DispatcherQueueHandler, but with `using Windows.System`
        // the unqualified name binds to Windows.System.DispatcherQueueHandler, a distinct
        // delegate type -> CS1503. Qualified here rather than changing the using, so the
        // Windows build keeps binding exactly what it binds today.
        private readonly Microsoft.UI.Dispatching.DispatcherQueueHandler _drain;
#else
