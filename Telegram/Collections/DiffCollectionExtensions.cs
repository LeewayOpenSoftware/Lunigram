...
namespace Telegram.Collections
{
    public static class DiffCollectionExtensions
    {
        ...
        // The #if !LINUX that used to sit here came from the bulk port commit 32dae80 and had no
        // API reason: KeyedCollection<T> is declared inside ViewModels/SearchChatsViewModel.cs,
        // which was out of the subset, so this one method did not resolve. The search screen is in
        // now, and all four search view models call Reuse on every batch of results.
