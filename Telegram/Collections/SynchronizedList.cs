...
#if LINUX
            // Uno never raises CompositionTarget.Rendered, so on Linux the fallback timer was the
            // only trigger and every removal waited 100 ms. See
            // Telegram.Linux/Xaml/CompositionRenderedClock.cs.
            Common.CompositionRenderedClock.Rendered += OnRendered;
#else
