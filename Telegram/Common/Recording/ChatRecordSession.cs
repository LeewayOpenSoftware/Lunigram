...
namespace Telegram.Common.Recording
{
    ...
    public partial class ChatRecordSession
    {
        ...
        private Microsoft.UI.Dispatching.DispatcherQueueTimer _limitTimer;
        ...
        private void OnLimitTick(Microsoft.UI.Dispatching.DispatcherQueueTimer sender, object args)
        {
