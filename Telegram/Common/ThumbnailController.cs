...
#if LINUX
// See Telegram/Controls/ImageView.cs: Uno's SoftwareBitmapSource is inert, BitmapImage is not.
// SoftwareBitmap follows it, because Uno's cannot give its pixels back either (LockBuffer throws,
// CopyToBuffer is a no-op) -- Telegram.Native.PixelBitmap is what DrawBlurred returns here.
using SoftwareBitmapSource = Microsoft.UI.Xaml.Media.Imaging.BitmapImage;
using SoftwareBitmap = Telegram.Native.PixelBitmap;
#endif
