...
{
// Everything here is COM: WinRT interface vtables and the activation factory behind
// CompositionTargetImpl. On Linux there is no COM and Uno's own CompositionTarget is used instead.
#if !LINUX
...
#if NET9_0_OR_GREATER
    // Microsoft.UI.Xaml.Media.ICompositionTargetStatics. Only the Rendering pair is declared, but the
    ...
    // Microsoft.UI.Xaml.Media.ICompositionTargetStatics3, which is where Rendered lives. Its vtable
    ...
    /// <summary>
    /// Stands in for <see cref="Microsoft.UI.Xaml.Media.CompositionTarget"/>, which CsWinRT cannot
    ...
    public static partial class CompositionTargetImpl
    {
        ...
        {
            const string name = "Microsoft.UI.Xaml.Media.CompositionTarget";
