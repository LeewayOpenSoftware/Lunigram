...
namespace Telegram.Common
{
...
#if LINUX
    // IDrawerGroup lives in ViewModels/Drawers/EmojiDrawerViewModel.cs, outside the Phase 1 subset.
    ...
    public static partial class Emoji
    {
        ...
        // Was under #if !LINUX only because its return type, StickerViewModel, is declared in
        // ViewModels/Drawers/StickerDrawerViewModel.cs, which was outside the subset until u-003.
