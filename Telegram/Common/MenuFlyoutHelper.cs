...
namespace Telegram.Common
{
    public static class MenuFlyoutHelper
    {
        ...
        // Was under #if !LINUX while ItemContextRequestedEventArgs<T> (Controls/Drawers) was out of
        // the subset. Since u-003 the drawers are in and ChatView.Drawers.cs calls this, so the
        // guard is gone -- the body was never Windows-specific, only its argument type was absent.
