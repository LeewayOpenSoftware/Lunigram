...
#if LINUX
        // internal rather than public: see SettingsLoginEmailAddressPopup.CodeInfo for why (Uno's
        // BindableTypeProviders emits a bare typeof(global::X) for types built by another source
        // generator, which is CS0400).
        internal EmailAddressAuthenticationCodeInfo RecoveryEmailAddressCodeInfo { get; private set; }
#else
