...
namespace Telegram.Views.Gifts.Popups
{
    public sealed partial class GiftCraftPopup : ContentPopup
    {
        ...
        private void Craft_Click(object sender, RoutedEventArgs e)
        {
            ...
            // follows whatever happens to be invalidating the window, so an animation that draws
            // from it is its own metronome. See Telegram.Linux/Xaml/CompositionRenderingClock.cs.
            CompositionRenderingClock.Rendering += OnRendering;
#else
            CompositionTarget.Rendering += OnRendering;
#endif
