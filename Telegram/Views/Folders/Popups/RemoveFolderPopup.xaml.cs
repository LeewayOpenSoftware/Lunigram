...
#if LINUX
            TextBlockHelper.SetMarkdown(SubtitleLabel, SubtitleLabel.Inlines, Strings.FolderLinkSubtitleRemove);
#endif
        }
        ...
        private void OnContainerContentChanging(ListViewBase sender, ContainerContentChangingEventArgs args)
        {
            ...
            ProfileTabContainer.Bind<ChatShareCell>(sender, args, null, (content, item) =>
            {
                if (item is Chat chat)
                {
                    ...
                    content.UpdateChatInflated(ViewModel.ClientService, chat);
                }
            });
#else
