...
namespace Telegram.Views.Popups
{
    public sealed partial class ProxyPopup : ContentPopup
    {
        ...
        // internal under #if LINUX: same CS0400 fix as ProxyViewModel.Proxy
        // (ViewModels/Settings/SettingsProxyViewModel.cs) - see the comment there.
#if LINUX
        internal
#else
        public
#endif
            Proxy Proxy => new Proxy(Server, Port, Type);
