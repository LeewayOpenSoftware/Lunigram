...
namespace Telegram.Views.Popups
{
    public sealed partial class CocoonAboutPopup : ContentPopup
    {
        public CocoonAboutPopup()
        {
            ...
            // See the note in AboutAdsPopup's constructor: an attached property whose value is a
            // custom markup extension does not survive Uno's XAML generator, so the subtitle's
            // markdown is set from here instead of from the markup.
            TextBlockHelper.SetMarkdown(Subtitle, Strings.CocoonSubtitle);
