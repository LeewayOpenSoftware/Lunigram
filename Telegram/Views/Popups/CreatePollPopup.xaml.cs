...
namespace Telegram.Views.Popups
{
    ...
    public sealed partial class CreatePollPopup : ContentPopup
    {
        ...
        public CreatePollPopup(IClientService clientService, INavigationService navigationService, FormattedText question, bool forceQuiz, bool forceRegular, bool channel)
        {
            ...
            AutomationProperties.SetName(QuestionEmoji, Strings.Emoji);
            AutomationProperties.SetName(DescriptionEmoji, Strings.Emoji);
        ...
        private void Emoji_Loaded(object sender, RoutedEventArgs e)
        {
            if (sender is UIElement element)
            {
                AutomationProperties.SetName(element, Strings.Emoji);
            }
        }
