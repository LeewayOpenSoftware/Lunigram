    ...
    public sealed partial class ProfileRatingPopup : ContentPopup
    {
        ...
        private void Preview_Click(Hyperlink sender, HyperlinkClickEventArgs args)
        {
            ...
            if (PendingSlider.Visibility == Visibility.Visible)
            {
                ...
                anim1.DelayBehavior = Microsoft.UI.Composition.AnimationDelayBehavior.SetInitialValueBeforeDelay;
                ...
                anim2.DelayBehavior = Microsoft.UI.Composition.AnimationDelayBehavior.SetInitialValueBeforeDelay;
